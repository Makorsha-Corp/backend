"""Drop work_order_schedules and template generation_mode.

Revision ID: 061_drop_work_order_schedules
Revises: 060_work_order_schedule_pending_payload
"""
...
revision = '061_drop_work_order_schedules'
down_revision = '060_work_order_schedule_pending_payload'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    if column_exists('work_order_templates', 'generation_mode'):
        op.drop_column('work_order_templates', 'generation_mode')


def downgrade() -> None:
    if not column_exists('work_order_templates', 'generation_mode'):
        op.add_column(
    ...
    op.create_table(
        ...
        sa.Column('status', schedule_status, nullable=False, server_default='STAGED'),
